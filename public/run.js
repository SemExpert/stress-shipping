...
async.parallel(list.map(credenciales => (() => runProcess(credenciales.clientId, credenciales.clientSecret, credenciales.email, credenciales.password, credenciales.seller))));
